...
\section The Academics Chair shall promote and encourage the highest possible academic achievement of each active and pledge. The Academics Chair is in charge of mandatory study hours. The accountability report of the Academics Chair consists of records of each member’s fulfillment of required study hours.
...
\section There will be five active committees: Recruitment, Scholarship, Brotherhood, Social, and Philanthropy.
...
\section The Scholarship Committee is in charge of proctoring and verifying study hours. It is led by the Scholarship Chair. 
...
\section During the entirety of a pledge’s pledging semester, each pledge shall pay monetary dues required of him. These monies shall cover the national initiation fee, and the pledge program fees. The Treasurer of the active chapter shall provide to each pledge a detailed bill on how these monies are spent within the first three weeks of pledging. The Treasurer shall also determine the pledge fee during the same meeting as when the semesterly budget is calculated. These monies shall be called due ninety days after the pledge undergoes the pledging ceremony. The balance shall accrue to the general fund of the Active Organization. No part of the initiation fee shall be used for any purpose other than the national initiation pledging fees. 
...
\section A Judiciary Committee shall be formed in the event that a dispute occurs that cannot be handled by the Vice-President alone. The Vice-President in this case will nominate three non-partisan brothers to be approved by the Executive Council.
...
\section Once approved, this committee is to investigate the situation in regards to the Constitution and the Code of Ethics and report to the Active Organization with the course of action.
...
\begin{itemize}
    ...
    \item As long as payment is still owed, payments may be made no less frequently than the seventh of each month starting with the first full month of the semester.
\end{itemize}
...
\section If a member of the Active Organization misses a chapter meeting for an unexcused reason, the member will lose their right of vote. In the event of a second unexcused absence, the member will also lose their right of voice and their right to attend to social events. A member can restore the rights that they have lost by attending all chapter meetings for two consecutive weeks.

\section If a member of the Active Organization fails to attend a chapter meeting when compelled to do so by the Sergeant-at-Arms, the member will loose their right to attend social events until they have attended all chapter meetings for two consecutive weeks
...
\section If a member of the Active Organization fails to meet the number of required study hours as defined by the  Scholarship Chair, they will lose their right to attend social events. The member may have this right restored by making up study hours in a manner deemed acceptable by the  Scholarship Chair
...
\section If a member of the Active Organization misses a required philanthropy event for an unexcused reason, they will lose their right to attend social events. The member may have this right restored by making up the event(s) in a manner deemed acceptable by the Philanthropy Chair.